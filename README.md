...
## Getting Started
You can include the action in your workflow as `actions/amplify-cli-action@0.3.5`. Example (configuring amplify, building and deploying):
...
jobs:
  test:
    ...
    - name: configure amplify
      uses: jcmendez-acc/amplify-cli-action@0.3.5
      with:
